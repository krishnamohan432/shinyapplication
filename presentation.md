...
Overview
========================================================
This presentation contains documentation for the Diamond price prediction application. The application can be found [**here**] (https://krishnamohan.shinyapps.io/myapp/)
...
Both files can be found here: [**GitHub repo**](https://github.com/krishnamohan432/shinyapplication)
